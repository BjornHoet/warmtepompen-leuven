...
function t($key)
{
	...
	$messages = require __DIR__ . "/../locale/{$language}/messages.php";
 ...
 * @return string
 */
function getLanguage($defaultLanguage = 'nl')
{
    $language = null;
 ...
 * @return int|string
 */
function getLanguageFromBrowser($defaultLanguage = 'nl')
{
    $languages = [];
